    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ten_ca_thi', models.CharField(max_length=100, verbose_name=b'Ti\xc3\xaau \xc4\x91\xe1\xbb\x81 ca thi')),
            ...
            options={
                'verbose_name': 'Ca thi t\u1ef1 lu\u1eadn',
                'verbose_name_plural': 'Danh s\xe1ch ca thi t\u1ef1 lu\u1eadn',
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('ma_de_thi', models.CharField(unique=True, max_length=10, verbose_name=b'M\xc3\xa3 \xc4\x91\xe1\xbb\x81 thi')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Ng\xe2n h\xe0ng \u0111\u1ec1 thi t\u1ef1 lu\u1eadn',
            },
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='ngan_hang',
            field=models.ForeignKey(verbose_name=b'Ng\xc3\xa2n h\xc3\xa0ng', to='quiz.NganHangDeThiTuLuan'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='doi_tuong',
            field=models.ForeignKey(verbose_name=b'\xc4\x90\xe1\xbb\x91i t\xc6\xb0\xe1\xbb\xa3ng', to='quiz.DoiTuong'),
        ),
        migrations.AddField(
            model_name='cathituluan',
            name='ds_de_thi',
        ...
        migrations.AddField(
            model_name='cathituluan',
            name='lop',
            field=models.ForeignKey(verbose_name=b'L\xe1\xbb\x9bp', to='quiz.Lop'),
        ),
        migrations.AddField(
            model_name='cathituluan',
            name='mon_thi',
